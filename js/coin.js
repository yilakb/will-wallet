/*
 Will-Wallet's Bitcoin transaction engine: keys, addresses, scripts,
 multisig, timelocks, and transaction construction/signing.

 Based on Coinjs by OutCast3k{at}gmail.com (http://github.com/OutCast3k/coinjs),
 used here under its original MIT license (see LICENSE).
*/
...
(function () {
	...
	/* default public blockchain API vars (used unless a local Bitcoin Core RPC
	   connection is configured in Settings) */
	...
	*/
	...
	coinjs.transaction = function() {
		...
		r.transactionHashSegWitV0 = function(index, sigHashType){
			/* 
			   Notice: our default public API deals with segwit transactions in a non-standard way.
